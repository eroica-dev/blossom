...
an embedded `BlossomLogStore` and commits:
...
commit. Steady-state storage work scales with the new epoch bytes plus ordered
table indexes; full-history validation occurs at startup and explicit recovery.

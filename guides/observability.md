...
The authoritative Blossom campaign in
`eden-dev-inc/deterministic-simulation` builds `blossom-sim` with
`observability`. Each run writes:
...
```bash
scripts/blossom/run-campaign.sh pr 1 600
```

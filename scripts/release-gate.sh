...
run_step cargo-check-active-active \
  cargo check -p blossom-consensus --no-default-features --features active-active
run_step cargo-check-active-passive \
  cargo check -p blossom-consensus --no-default-features --features active-passive
run_step cargo-check-propagation-push \
  cargo check -p blossom-consensus --no-default-features --features propagation-push
run_step cargo-check-propagation-inventory \
  cargo check -p blossom-consensus --no-default-features --features propagation-inventory
run_step cargo-check-propagation-adaptive \
  cargo check -p blossom-consensus --no-default-features --features propagation-adaptive

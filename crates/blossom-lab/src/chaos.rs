...
mod tests {
    ...
    #[tokio::test]
    async fn lab_cluster_counts_successful_delayed_requests() {
        let cluster = LabCluster::spawn(
            1,
            NetworkChaosConfig {
                latency_ms: 1,
    ...
    #[tokio::test]
    async fn lab_cluster_can_drop_before_connecting() {
        let cluster = LabCluster::spawn(
            1,
            NetworkChaosConfig {
    ...
    #[tokio::test]
    async fn lab_cluster_can_crash_connections() {
        let cluster = LabCluster::spawn(
            1,
            NetworkChaosConfig {
